 ...
 * @author ellison
 * @date 2019年03月19日
 * @desc 设置TextView 的SpannableString
 */
public class TextSpanUtils {
    ...
    private TextSpanUtils(TextView textView) {
        this();
        mTextView = textView;
    }
     ...
     *             </ul>
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setStrikethrough() {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setUnderline() {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setSuperscript() {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setSubscript() {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setItalic() {
        isItalic = true;
        return this;
    }
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setHorizontalAlign(@NonNull final Layout.Alignment alignment) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setUrl(@NonNull final String url) {
        if (mTextView != null && mTextView.getMovementMethod() == null) {
            mTextView.setMovementMethod(LinkMovementMethod.getInstance());
        }
        this.url = url;
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                   final float dx,
                                   final float dy,
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link TextSpanUtils} instance
     */
    public TextSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            }
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(DefaultApplication.getInstance().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            DefaultApplication.getInstance().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(DefaultApplication.getInstance().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(DefaultApplication.getInstance(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
...
//                    "lineHeight: " + (bottom - top));
    ...
    public static TextSpanUtils with(final TextView textView) {
